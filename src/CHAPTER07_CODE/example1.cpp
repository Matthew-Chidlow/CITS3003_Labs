 ...
 * Change the rotation angle values for the x, y, and z axes with the
...
// incremental value (in degs) for the rotation angle (used in the 'idle'
// function. Increase/decrease this value if the rotation is too slow/fast.
const float dTheta = 0.5;   
