...
const int NumQuadsPerPatch = 64;   // = 4^3
const int NumTriangles = NumTeapotPatches * NumQuadsPerPatch * 2; /* 2 triangles per quad */
const int NumVertices = NumTriangles * 3; /* 3 vertices per triangle */
