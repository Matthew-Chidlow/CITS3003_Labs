...
//   those colors across the triangles. Inspect the code in the display and
//   keyboard functions carefully.
//
// Revised by Du Huynh
...
const GLfloat default_radius = 3.0;
...
void display( void )
{
    ...
    char title[256];
    sprintf(title, "(near,far,r,theta,phi)=(%1.2f,%1.2f,%1.2f,%1.2f,%1.2f)",zNear,zFar,radius,theta,phi);
